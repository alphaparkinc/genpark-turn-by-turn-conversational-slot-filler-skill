# genpark-turn-by-turn-conversational-slot-filler-skill
...
<p align="center">
  <b>Production-Grade Voice Telephony Agent Skill</b> • <b>100% Standard Library Python</b> • <b>Native Model Context Protocol (MCP)</b>
</p>
...
**genpark-turn-by-turn-conversational-slot-filler-skill** is a deterministic, zero-dependency Python skill engineered for autonomous conversational voice agents, telephony IVR navigation, and real-time interruption arbitration.

> **Executive Capability**: Turn-by-turn spoken dialogue entity & slot filler (ThunderPhone / Vapi)
...
```mermaid
graph LR
    User([🌐 Caller / Phone Agent]) -->|JSON-RPC Request| MCP[⚡ MCP Server / CLI]
...
```json
{
  "mcpServers": {
    "genpark-turn-by-turn-conversational-slot-filler-skill": {
      "command": "python",
      "args": ["/path/to/genpark-turn-by-turn-conversational-slot-filler-skill/mcp_server.py"]
    }
  }
}
```
...
Explore the comprehensive directory of 1,200+ open-source, production-ready AI Agent skills at the [GenPark AI MCP Hub](https://genpark.ai/mcp) and learn more about voice telephony agents at [GenPark AI](https://genpark.ai).
